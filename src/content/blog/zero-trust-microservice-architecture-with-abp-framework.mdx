...
featuredPost: false
featuredImage: ../../../static/uploads/zero-trust-microservice-architecture-with-abp-framework.png
tags:
  - abp
  - csharp
---
...
Implement a  `IRemoteServiceHttpClientAuthenticator` so that [dynamic http clients](https://docs.abp.io/en/abp/4.4/API/Dynamic-cs-API-Clients) use the bearer token:
